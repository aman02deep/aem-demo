 ...
 * - add the data attribute cq-dialog-dropdown-hidefor-target to the dropdown/select element, value should be the
 ...
 * - add the attribute hidefortargetvalue (comma separated classes) to each target component,
